document.getElementById("run").onclick = function () {
    ...
    const frontJunk = generateMassiveJunkLines(100);
    const backJunk = generateMassiveJunkLines(100);
    ...
    const finalFrontJunk = generateMassiveJunkLines(50);
    const finalBackJunk = generateMassiveJunkLines(50);
    
    let finalWithJunk = finalFrontJunk + final + finalBackJunk;
    
    finalWithJunk = finalWithJunk.replace(/\s+/g, ' ').trim();
    
    finalWithJunk = finalWithJunk.replace(/;/g, '; ');
