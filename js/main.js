...
local function simpleBase64Decode(str)
...
local key = simpleBase64Decode("${keyB64}")
local data = simpleBase64Decode("${encryptedB64}")
local out = xorDecrypt(data, key)
loadstring(out)()
`;
...
local stubKey = simpleBase64Decode("${stubKeyB64}")
local stubEnc = simpleBase64Decode("${encryptedStubB64}")
local realStub = xorDecrypt(stubEnc, stubKey)
loadstring(realStub)()
`;
